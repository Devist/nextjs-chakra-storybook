import { IPostData } from '@core-business/entities'
import { APIClient } from '@core-business/network/APIClient'
import { PostAPI } from '@core-business/network/apis/PostAPI'
...
export class PostsRepository implements IPostsRepository {
  ...
  async saveItem(params: IPostData): Promise<IPostData> {
    if (params.id)
      return await APIClient.shared.request(new PostAPI.Update(params))
